...
static String nam;
  ...
  static ArrayList<String> adminwalo = new ArrayList<String>();
  static int i;
...
WindowListener exitListener = new WindowAdapter() {
    ...
    public void windowClosing(WindowEvent e) {
        ...
        if (confirm == 0) {
             ...
             if(admin){
            //Clientchat.adminwalo.remove(nam);
            i--;
           
            System.out.println(Clientchat.adminwalo);
            if(i==0){
            Clientchat.out.println("shutdown");
            }else{
            Clientchat.out.println("!@#$!@#$!@#");
            Clientchat.out.println("admincount"+i);
            }
        }else{
   Clientchat.out.println("!@#$!@#$!@#");
        }
...
chatWindow.setVisible(true);
...

    {
       ...
       //ip1 = JOptionPane.showInputDialog(
...
JLabel lbl = new JLabel("Enter IP Address:");
JTextField txt = new JTextField(10);
panel.add(lbl);
panel.add(txt);
              ip1= JOptionPane.showOptionDialog(chatWindow,panel, "IP Address Required!!", JOptionPane.NO_OPTION, JOptionPane.QUESTION_MESSAGE, null,options,options[0]);
...
//JFrame frame = new JFrame();
           ...
           else if(str.equals("cannotremoveadmin")){
               
                          JOptionPane.showMessageDialog(chatWindow,"admin left the chat chatroom close!!","Alert",JOptionPane.INFORMATION_MESSAGE);    
           ...
           }else if(str.equals("shutdownclients")){
...
textField.setEditable(true);
Clientchat.adminwalo.add(nam);
i=Integer.parseInt(str.substring(7, str.length()));
System.out.println("admin "+Clientchat.adminwalo);
admin=true;
               ...
               if(str.startsWith("admincount")){
               
               i=Integer.parseInt(str.substring(10, str.length()));            
